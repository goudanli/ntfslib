 ...
 * Returns:
 */
s64 ntfs_device_unix_io_seek(struct ntfs_device *dev, s64 offset,
		int whence)
{
 ...
 * Returns:
 */
s64 ntfs_device_unix_io_read(struct ntfs_device *dev, void *buf,
		s64 count)
{
 ...
 * Returns:
 */
s64 ntfs_device_unix_io_write(struct ntfs_device *dev, const void *buf,
		s64 count)
{
	if (NDevReadOnly(dev)) {
		errno = EROFS;
 ...
 * Returns:
 */
s64 ntfs_device_unix_io_pread(struct ntfs_device *dev, void *buf,
 ...
 * Returns:
 */
s64 ntfs_device_unix_io_pwrite(struct ntfs_device *dev, const void *buf,
		s64 count, s64 offset)
{
	if (NDevReadOnly(dev)) {
		errno = EROFS;
 ...
 * Returns:
 */
int ntfs_device_unix_io_ioctl(struct ntfs_device *dev, int request,
		void *argp)
{
